...
num_lines=1;
Calculation_default_answer={'no', '698', '393',  '1920', '1080', '5', '5' '0.24', '2.5', 'Inferior', 'Fixation', '700'};
...
if strcmp(ptb, 'no')
    ...
    Disk_Diameter_scale=str2double(Calculation_info{8});
...
%% Degree Disk 
Disk_Diameter_Deg=(Disk_Diameter_scale*Window_Width_pixels)/pix_deg
...
DVA_pixels_width=DistancetoStimulus * pix_deg;
Disk_Radius_Pixels=  (Disk_Diameter_Deg/2)*pix_deg;
...
Distance_TrainedLocation_Pixels= Distance_TrainedLocation * pix_deg;


% Shift Needed 
Distance_from_Fixation_Deg=(Disk_Diameter_Deg/2)+Distance_TrainedLocation; 
Distance_from_Fixation_Pixels=Distance_from_Fixation_Deg*pix_deg;
